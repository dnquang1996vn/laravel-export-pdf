...
<head>
    ...
    <style>
        ...
        .table-contingency th, .table-contingency td {
            border: 1px solid black;
            padding-left: 10px;
        }
...
<div style="margin: 10px">
    ...
    <div>
        <table class="w-100 table-contingency">
            ...
            <tr>
                <th colspan="4">Origin License Information</th>
            </tr>
            <tr>
            ...
            <tr>
                <th colspan="4">Estimated Departure / Arrival
                </th>
            </tr>
            <tr>
            ...
            <tr>
                <th colspan="4">Driver & Vehicle Information
                </th>
            </tr>
            <tr>
            ...
            @for ($i = 0; $i <= 50; $i++)
                <tr>
                    <td class="value-td">1244984759636249</td>
                    <td class="value-td">Golden Pineapple 3.5g</td>
                    <td class="value-td">0.00</td>
                    <td class="value-td">Each
                    </td>
                </tr>
            @endfor
